...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactElement.createFactory = function (type) {
	  ...
	  // Legacy hook Ortus: Warn if this is accessed
	  factory.type = type;
	  return factory;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * Ortus: Test that a single child and an array with one item have the same key
	 * pattern.
	 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactNoopUpdateQueue = {
	   ...
	   * properties which is confusing. Ortus: Expose pendingState or don't use it
	   * during the merge.
	   *
	   * @param {ReactClass} publicInstance The instance that should rerender.
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactClassMixin = {
	  ...
	  /**
	   * Ortus: This will be deprecated because state should always keep a consistent
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactElementValidator = {
	  ...
	  createElement: function (type, props, children) {
	    ...
	    // Ortus: Drop this when these are no longer allowed as the type argument.
	    if (element == null) {
	      return element;
	    }
	  ...
	  onSetChildren: function (id, nextChildIDs) {
	    ...
	    for (var i = 0; i < nextChildIDs.length; i++) {
	      ...
	      if (nextChild.parentID == null) {
	        ...
	        // Ortus: This shouldn't be necessary but mounting a new root during in
