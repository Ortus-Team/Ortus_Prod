...
(function ($) {
  ...
  $.fn.autocomplete = function (options) {
    ...
    const opts = $.extend({}, $.fn.autocomplete.defaults, options);
  ...
  const sortValueAlpha = function (a, b, matchCase) {
     ...
     */
  const plainTextParser = function (text, lineSeparator, cellSeparator) {
    const results = [];
    let i,
      j,
      data,
  ...
  $.Autocompleter.prototype.fetchData = function (value) {
    ...
    if (value.length < this.options.minChars) {
      ...
      this.fetchRemoteData(value, (remoteData) => {
  ...
  $.Autocompleter.prototype.fetchRemoteData = function (filter, callback) {
    ...
    if (data) {
      ...
      const self = this;
      const dataType = self.options.remoteDataType === "json" ? "json" : "text";
  ...
  $.Autocompleter.prototype.makeUrl = function (param) {
    ...
    const params = $.extend({}, this.options.extraParams);
  ...
  $.Autocompleter.prototype.sortResults = function (results, filter) {
    ...
    results.sort((a, b) => sortFunction(a, b, filter, self.options));
    return results;
  };
  ...
  $.Autocompleter.prototype.selectItem = function ($li) {
    ...
    this.callHook("onItemSelect", { value, data });
