...
!(function (e) {
  let n = function (n) {
      const a = e("<span />", { class: "collapser",
        on: { click() {
          const n = e(this); n.toggleClass("collapsed"); let a = n.parent().children(".block"),
            p = a.children("ul"); n.hasClass("collapsed") ? (p.hide(), a.children(".dots, .comments").show()) : (p.show(), a.children(".dots, .comments").hide());
        } } }); return n && a.addClass("collapsed"), a;
    },
    a = function (a, p) {
      var t = e.extend({}, { nl2br: !0 }, p),
        r = function (e) { return e.toString() ? e.toString().replace(/&/g, "&amp;").replace(/"/g, "&quot;").replace(/</g, "&lt;").replace(/>/g, "&gt;") : ""; },
        s = function (n, a) { return e("<span />", { class: a, html: r(n) }); },
        l = function (a, p) {
          switch (e.type(a)) {
            case "object":p || (p = 0); var c = e("<span />", { class: "block" }),
              d = Object.keys(a).length; if (!d) return c.append(s("{", "b")).append(" ").append(s("}", "b")); c.append(s("{", "b")); var i = e("<ul />", { class: `obj collapsible level${p}` }); return e.each(a, (a, t) => { d--; const r = e("<li />").append(s("\"", "q")).append(a).append(s("\"", "q")).append(": ").append(l(t, p + 1)); ["object", "array"].indexOf(e.type(t)) === -1 || e.isEmptyObject(t) || r.prepend(n()), d > 0 && r.append(","), i.append(r); }), c.append(i), c.append(s("...", "dots")), c.append(s("}", "b")), c.append(Object.keys(a).length === 1 ? s("// 1 item", "comments") : s(`// ${Object.keys(a).length} items`, "comments")), c; case "array":p || (p = 0); var d = a.length,
