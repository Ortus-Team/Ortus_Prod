...
j; let u = i.ownerDocument,
    ...
    regexLiterals: !0 }), ["coffee"]); k(x([], [["str", /^[\S\s]+/]]), ["regex"]); window.prettyPrintOne = function (a, m, e) { const h = document.createElement("PRE"); h.innerHTML = a; e && D(h, e); E({ g: m, i: e, h }); return h.innerHTML; }; window.prettyPrint = function (a) {
    function m() {
