...
(function () {
  var DateTimeShortcuts = {
    ...
    init() {
      ...
      const serverOffset = body.getAttribute("data-admin-utc-offset");
      if (serverOffset) {
    ...
    addClock(inp) {
      ...
      addEvent(cancel_link, "click", (e) => {
        e.preventDefault();
        DateTimeShortcuts.dismissClock(num);
      });

      django.jQuery(document).bind("keyup", (event) => {
        if (event.which === 27) {
    ...
    handleCalendarQuickLink(num, offset) {
